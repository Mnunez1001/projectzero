...
public Mortal(int age, double weight, double height, boolean animal, boolean
lawAbiding, boolean pregnant,
...
return "Mortal [age=" + age + ", weight=" + weight + ", height=" + height +
", animal=" + animal
+ ", lawAbiding=" + lawAbiding + ", pregnant=" + pregnant + ", socialClass=" + socialClass

+ ", species=" + species + ", inCar=" + inCar + ", gender=" +
gender + "]";
}
